...
$sql = "SELECT * FROM antiques360 WHERE Antiques360 = '$Antiques360'";
...
<body>
    <div class="bg-main ">
        <form action="edit_antiqDB.php" method="post" enctype="multipart/form-data">
            <div class="col-sm-12 col-md-12  container pt-5 ">
                <div class="border w-75  mx-auto mb-3 rounded- bd-all p-3 ">
                    <h2 class="text-center pb-3 text-head">Edit Antiques 360</h2>
                    ...
                    <div class="w-100 mb-3 mx-auto">
                        <label class="form-label ft-text">Antiques360</label>
                        <input type="Antiques360" readonly class="form-control" name="Antiques360" value=<?= $row['Antiques360'] ?> require>
                    </div>
                    <div class="w-100 mb-3 mx-auto">
                    ...
                    <div class=" w-100 mb-3 mx-auto">
                        ...
                        <input class="form-control" name="drescription" rows="3" value=<?= $row['drescription'] ?>></input>
                    </div>
