...
<body>
    ...
    <div class="bg-main ">
        <form action="add_antiqDB.php" method="post" enctype="multipart/form-data">
            <div class="col-sm-12 col-md-12  container pt-5  ">
                <div class=" border w-75  mx-auto mb-3 rounded- bd-all p-3 ">
                    <h2 class="text-center pb-3 text-head">Add Antiques 360</h2>
                    ...
                    <div class=" w-100 mb-3 mx-auto">
                        ...
                        <textarea class="form-control" name="drescription" rows="3"></textarea>
                    </div>
