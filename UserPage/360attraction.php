  ...
  <div class="mt-5 py-auto">
    <div class="container  ">
      <div class=" text-center h2 " role="alert">
        <p class="pt-5 fw-bold text-head ">Attractions 360</p>
      </div>
    </div>
  </div>
        ...
        <div class="container col-xl-6 col-sm-12 col-md-10 col-xxl-4">
          ...
          <main class="grid h-100 ">
            <article class="ms-5 p-2">
              ...
              <a href="../antiquesTour360.php?file360url=<?php echo $result['url']; ?>"><button class="btn btn-primary mb-2 fw-bold btView">View</button></a>
