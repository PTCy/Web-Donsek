...
<body>
    ...
    <div class="mt-5 py-auto">
        <div class="container  ">
            <div class=" text-center h2 " role="alert">
                <p class="pt-5 fw-bold text-head ">Antiquities VR</p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="container col-xl-6 col-sm-12 col-md-12 col-xxl-8">

                <!-- <main class="grid h-100 ">
                    <article class="ms-5 p-2">

                        <img src="../images/temple.jpg" class="card-img-top" alt="">

                        <h3 class="card-title mt-2"> Test </h3>
                        <p class="card-text"> Detail </p>

                        <a href="VR_antiq.php"><button class="btn btn-primary fw-bold btView mb-2">View</button></a>

                    </article>
                </main> -->
                <div>
                    <iframe width="100%" height="" style="width: 100%; height: 70vh; border: none; max-width: 100%;" allow="xr-spatial-tracking; vr; gyroscope; accelerometer; fullscreen; autoplay; xr" scrolling="no" allowfullscreen="true" frameborder="0" src="https://webobook.com/public/62f758850514ba7e51730b62,en?ap=true&si=true&sm=false&sp=true&sfr=false&sl=false&sop=false&" allowvr="yes"></iframe>
                </div>
            </div>
        </div>
    </div>
