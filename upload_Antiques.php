...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="upload_antiq.css">
...
<body>
    ...
    <div class="container">
        <div class="container mt-3">
            <a href="add_antiq.php"><button class="btn btn-primary mb-2 fs-5 fw-bold btn-Add">Add +</button></a>
        </div>
        <div class="row">
                ...
                <div class="container col-xl-6 col-sm-12 col-md-10 col-xxl-4">
                    ...
                    <main class="grid h-100 ">
                        <article class="ms-5 p-2">
                            ...
                            <a href="edit_antiq.php?Antiques360=<?= $result['Antiques360'] ?>"><button class="btn  btn-primary mb-2 fw-bold btn-Edit">Edit</button></a>

                            <a href="delete_antiqDB.php?Antiques360=<?= $result['Antiques360'] ?>">
